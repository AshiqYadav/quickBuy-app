...
fun SignInScreen(
    ...
    when (val state = authState.value) {
        ...
        is AuthState.Unauthenticated -> {
            SignInContent(navHostController = navController, authViewModel = authViewModel)
        }
...
@Composable
fun SignInContent(navHostController: NavHostController, authViewModel: AuthViewModel) {
            ...
            Row(
                ...
                Icon(
                    ...
                    modifier = Modifier
                        ...
                        .clickable(
                            enabled = true,
                            onClick = { navHostController.navigate(Screen.signUp) }
                        )
                )
